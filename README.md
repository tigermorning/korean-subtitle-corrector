...
>
> "문맥 의존 띄어쓰기에 근거 검색(임베딩/RAG)을 쓸 수 있는가" — 문제 정의서, PoC 코드,
> 평가셋 46건, 5개 방식 비교, 실패 사례, 최종 결론이 그 폴더 안에 전부 있다.
> **결론: 가설 기각.** 임베딩 검색은 비신경 방법보다 못했다. 자세한 것은
> [PoC README](./poc/mq2-spacing-retrieval/README.md) 참고.
