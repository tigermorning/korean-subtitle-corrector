...
# 의존명사(NNB, '개'·'년'·'번')가 앞에 오면 그 뒤 명사(또는 의존명사 자신)는
# 수량을 받는 명사구의 머리다 — 뒤에 오는 '하다/되다'는 그 명사에 붙는 접사가
# 아니라 별개 동사다('20번 했어', '3세트 해라'는 '했다/해라'가 '번'·'세트'에
# 붙는 게 아니다). affix.py의 correct_action_noun_affix와 spacing.py의
# _mechanical_respace가 같은 판정을 각자 다른 경로로 내려야 해서 여기 모았다
# (실사용 감수로 확인: '번하다'가 우연히 표준국어대사전 표제어 — '어두운 가운데
# 밝은 빛이 비치어 조금 훤하다'라는 무관한 뜻 — 라서 원리3 우연한 사전 충돌로
# '20번 했어'가 '20번했어'로 붙었다, 2026-09-02).
