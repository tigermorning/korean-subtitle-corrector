...
PRECEDENTS: list[dict] = [
    ...
    # },
    {
        ...
        "correct": False,
        "source": (
            "질문: '집에 가서 준비하다'와 '집에 갈 준비 하다'의 띄어쓰기가 다른 "
            "이유 -> 답변: '갈'은 관형절로서 명사 '준비'를 수식하므로 '준비'가 "
            "'하다'의 목적어로 기능해 '갈 준비(를) 하다'로 띄어 씀. 관형절의 "
            "수식을 받는 명사는 '명사+하다' 합성동사로 붙여 쓸 수 없다는 구조적 "
            "규칙의 근거 사례(PRD.md §18 일반 규칙 참고, qna_seq=309680)."
        ),
        "verified": "2026-07-21",
    },
]
